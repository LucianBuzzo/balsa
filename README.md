...
* [beedrill](#module_beedrill)
    ...
    * [.has(object, key)](#module_beedrill.has) ⇒ <code>Boolean</code>
...
**Kind**: static method of <code>[beedrill](#module_beedrill)</code>  
...
### beedrill.has(object, key) ⇒ <code>Boolean</code>
Checks if key is a direct property of object.

**Kind**: static method of <code>[beedrill](#module_beedrill)</code>  
**Returns**: <code>Boolean</code> - - Returns true if the key exists, else false.  
**Access:** public  
